...
import { ArrowLeft, Heart, Mail, Phone, Lock, Eye, EyeOff, FileCheck, Loader2, MapPin } from "lucide-react";
...
export const OrganizationAuth = ({ onBack, onSuccess }: OrganizationAuthProps) => {
  ...
  const [formData, setFormData] = useState({
    ...
    address: "",
    password: "",
    organizationType: "shelter" as "shelter" | "food_bank" | "community_kitchen" | "other",
  });
              ...
              <>
                ...
                <div className="space-y-2">
                  ...
                  <LocationPicker
                    ...
                    placeholder="Search your organization address..."
                    disabled={isLoading}
                  />
                </div>
